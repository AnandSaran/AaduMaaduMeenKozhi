package com.aadu_maadu_kozhi.gregantech.customview.likeanimation;
...
public class LikeButtonView extends FrameLayout {
    ...
    private void init() {
        ...
        vDotsView = view.findViewById(R.id.vDotsView);
        vCircle = view.findViewById(R.id.vCircle);
    ...
    public void setImageStar() {
        ivStar.setImageResource(isChecked ? R.drawable.ic_star_yellow_24dp : R.drawable.ic_star_grey_24dp);
    ...
    public void performClickOperation() {
        ...
        if (isChecked) {
            vDotsView.setVisibility(VISIBLE);
            vCircle.setVisibility(VISIBLE);
            ...
            ObjectAnimator dotsAnimator = ObjectAnimator.ofFloat(vDotsView, DotsView.DOTS_PROGRESS, 0.1f, 1f);
            ...
            vDotsView.setVisibility(INVISIBLE);
            vCircle.setVisibility(INVISIBLE);
        }
    }
}